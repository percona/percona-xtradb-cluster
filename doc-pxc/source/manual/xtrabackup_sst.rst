...
This change has introduced incompatibilities with older versions, refer to Incompatibilities in `Errata <http://www.percona.com/doc/percona-xtradb-cluster/errata.html>`_ for more details.
