...
copyright = u'Percona LLC and/or its affiliates 2009-2014'
...
latex_documents = [
  ('index', 'PerconaXtraDBCluster-5.6.tex', u'Percona XtraDB Cluster Documentation',
   u'Percona LLC and/or its affiliates 2009-2014', 'manual'),
]
...
man_pages = [
    ('index', 'perconaxtradbcluster', u'Percona XtraDB Cluster Documentation',
     [u'Percona LLC and/or its affiliates 2009-2014'], 1)
]
