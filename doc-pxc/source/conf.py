...
copyright = u'2012-2014, Percona LLC and/or its affiliates'
...
extlinks = {'bug': ('https://bugs.launchpad.net/percona-xtradb-cluster/+bug/%s',
...
html_title = 'Percona XtraDB Cluster 5.5 Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Percona XtraDB Cluster 5.5 Documentation'
...
latex_documents = [
  ('index', 'PerconaXtraDBCluster-5.5.tex', u'Percona XtraDB Cluster 5.5 Documentation', 
   u'2012-2014, Percona LLC and/or its affiliates', 'manual'),
]
...
man_pages = [
    ('index', 'perconaxtradbcluster', u'Percona XtraDB Cluster Documentation',
     [u'2012-2014, Percona LLC and/or its affiliates'], 1)
]
