...
copyright = u'2012-2013, Percona LLC and/or its affiliates'
...
html_short_title = 'XtraDB Cluster Docs'
...
latex_documents = [
  ('index', 'PerconaXtraDBCluster.tex', u'Percona XtraDB Cluster Documentation',
   u'2012-2013, Percona LLC and/or its affiliates', 'manual'),
]
...
man_pages = [
    ('index', 'perconaxtradbcluster', u'Percona XtraDB Cluster Documentation',
     [u'2012-2013, Percona LLC and/or its affiliates'], 1)
]
