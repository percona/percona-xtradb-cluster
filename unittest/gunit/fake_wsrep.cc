...
extern "C" bool wsrep_thd_is_BF(const THD *thd [[maybe_unused]], bool sync [[maybe_unused]]) {
    return false;
}
...
extern bool wsrep_handle_mdl_conflict(const MDL_context *requestor_ctx [[maybe_unused]],
                                      MDL_ticket *ticket [[maybe_unused]], const MDL_key *key [[maybe_unused]]) {
    return false;
}


extern bool debug_sync_set_action(THD *thd [[maybe_unused]], const char *action_str [[maybe_unused]], size_t len [[maybe_unused]]) {
    return false;
}
