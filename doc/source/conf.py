...
release = ".".join([version, '17-8'])

=======
release = ".".join([version, '18-9'])
...
||||||| merged common ancestors
  ('index', # source start file
   #target name, such as PerconaServer-5.7.tex
   '.'.join(['-'.join([''.join(project.split()), version]), 'tex']), 
   ' '.join([project, 'Documentation']), # title, such as Percona Server Documentation
   copyright, 
...
man_pages = [('index', # source start file
              ...
              [u'Percona LLC and/or its affiliates 2009-2020'], # authors
              1 # manual section
)]
