...
|Percona XtraDB Cluster| 5.6.32-25.17 on October 4th, 2016.
Binaries are available from the
`downloads section <https://www.percona.com/downloads/Percona-XtraDB-Cluster-56/Percona-XtraDB-Cluster-5.6.32-25.17/>`_
