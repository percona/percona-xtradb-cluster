...
class StmtExecute : public ::google::protobuf::MessageLite {
 public:
  StmtExecute();
  virtual ~StmtExecute();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_mysqlx_5fsql_2eproto_impl();
  #else
...
class StmtExecuteOk : public ::google::protobuf::MessageLite {
 public:
  StmtExecuteOk();
