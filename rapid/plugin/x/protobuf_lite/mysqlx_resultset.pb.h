...
class FetchDoneMoreOutParams : public ::google::protobuf::MessageLite {
 public:
...
class FetchDoneMoreResultsets : public ::google::protobuf::MessageLite {
 public:
...
class FetchDone : public ::google::protobuf::MessageLite {
 public:
  FetchDone();
  virtual ~FetchDone();
...
class ColumnMetaData : public ::google::protobuf::MessageLite {
 public:
  ColumnMetaData();
...
class Row : public ::google::protobuf::MessageLite {
 public:
  Row();
  virtual ~Row();
