...
class Scalar_String : public Mysqlx::Datatypes::Scalar_String
{
public:
  Scalar_String(const std::string& value)
  {
    set_value(value);
  }
};
...
class Scalar_Octets : public Mysqlx::Datatypes::Scalar_Octets
{
public:
  Scalar_Octets(const std::string& value, unsigned type)
  {
    set_value(value);
...
public:
  ...
  Scalar(Scalar_Octets* value);
  Scalar(Scalar_String* value);
  Scalar(Null value);
};
