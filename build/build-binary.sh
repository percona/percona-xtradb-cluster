...
COMMENT="$MYSQL_VERSION-$RELEASE_TAG, Percona XtraDB Cluster - binary (GPL), Release: $WSREP_VERSION"
COMMENT="$COMMENT, Revision $REVISION wsrep_$WSREP_VERSION.r$WSREP_REV"
