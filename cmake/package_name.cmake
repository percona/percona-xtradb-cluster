...
IF(NOT VERSION)
  ...
  ELSE()
    IF(WITH_WSREP)
      IF(NOT WSREP_PACKAGE_VERSION)
        MESSAGE(FATAL_ERROR "Variable WSREP_PACKAGE_VERSION must be set")
      ENDIF()
      SET(package_name "mysql${PRODUCT_TAG}-${VERSION}_wsrep_${WSREP_PACKAGE_VERSION}-${SYSTEM_NAME_AND_PROCESSOR}")
    ELSE()
